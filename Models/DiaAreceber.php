...
class  DiaAreceber extends Model
{
    ...
    public function inserir($dias, $idEmpresa)
    {
        ...
        $sql = "insert into diaAreceber(dias, empresa_idEmpresa) values(:dias, :idEmpresa)";
    ...
    public function getAllByEmpresa($idEmpresa)
    {
        ...
        $sql = "select * from diaAreceber where empresa_idEmpresa = :idEmpresa";
    ...
    public function atualizar($idDias,$dias,  $idEmpresa){
        ...
        $sql = "update diaAreceber set dias = :dias where iddiaAreceber = :iddiaAreceber  and empresa_idEmpresa = :idEmpresa";
        ...
        try{
            ...
            $update->bindValue(":iddiaAreceber",$idDias);
