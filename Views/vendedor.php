...
<div class="margem">
    ...
    ?>
            ...
            <div class="tirinhas">
                ...
                <div class="subtirinhas"><?php echo '#' . $vendedores['idVendedores']; ?></div>
                ...
                <div class="subtirinhas"><a id="atualizar" href="<?php echo BASE_URL; ?>Vendedores/atualizarVendedores/?id=<?php echo $vendedores['idVendedores']; ?>"><img class="imagemPequena" src="<?php echo BASE_URL; ?>assets/imagens/refresh.svg" /></a></div>
                <div class="subtirinhas"><a href="<?php echo BASE_URL; ?>Vendedores/deletarVendedores/?id=<?php echo $vendedores['idVendedores']; ?>"><img class="imagemPequena" src="<?php echo BASE_URL; ?>assets/imagens/delete.svg" /></a></div>
